            ...
            <div className="mask gradient-custom-3">
              <MDBCard className="m-5" style={{ maxWidth: '600px' }}>
                    ...
                    <table style={{ borderCollapse: 'collapse', border: '1px solid black', width: '100%' }}>
                      <thead>
                        <tr>
                          ...
                          >
                            <img
                              src="https://w7.pngwing.com/pngs/558/76/png-transparent-computer-icons-google-calendar-time-wall-clock-text-calendar-logo.png"
                              alt="Logo"
                              style={{ width: '30px', marginRight: '11px' }}
                            />
                            <div style={{ whiteSpace: 'nowrap' }}>{currentMonth} {currentDay}, {currentYear}</div>
                            <img
                              src="https://w7.pngwing.com/pngs/558/76/png-transparent-computer-icons-google-calendar-time-wall-clock-text-calendar-logo.png"
                              alt="Logo"
                              style={{ width: '30px', marginLeft: '11px' }}
                            />
                          </th>
                        </tr>
                        <tr>
                ...
                <div className="text-center">
                  <MDBBtn className="mb-4" onClick={() => handleNavigation('/AddSchedule')}>
                    Add Schedule
                  </MDBBtn>
                </div>
              </MDBCard>
